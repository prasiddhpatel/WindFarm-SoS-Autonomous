...
def test_mrta_hungarian_e2e():
    ...
    tasks = [
        # Task(task_id, task_type, reward, execution_cost, required_capability)
        Task('t_triage_01', 'triage', 9.0, 3.0, 'triage'),
        Task('t_nde_01',    'nde',    7.0, 5.0, 'nde'),
    ]
